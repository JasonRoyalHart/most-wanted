...
describe('function findNameFromId', function() {
  it('Find Billy Bob from Id', function() {
    expect(findNameFromId(data, "272822514")).toEqual("Billy Bob");
  });
});
...
describe('function findPersonFromId', function() {
  it('Find Billy Bob from Id', function() {
    expect(findPersonFromId(data, "272822514")).toEqual(	{
    		"id": 272822514,
    		"firstName": "Billy",
    		"lastName": "Bob",
    		"gender": "male",
...
describe('function findDobFromName', function() {
  it('Find Billy Bobs Dob from his name', function() {
    expect(findDobFromName(data, "Billy Bob")).toEqual("1/18/1949");
  });
});

describe('function getAge', function() {
  it('Find Billy Bobs age', function() {
    expect(getAge(data, 	{
    		"id": 272822514,
    		"firstName": "Billy",
    		"lastName": "Bob",
...
describe('function findPersonFromName', function() {
  it('Find Billy Bob from his name', function() {
    expect(findPersonFromName(data, "Billy Bob")).toEqual(	{
    		"id": 272822514,
    		"firstName": "Billy",
    		"lastName": "Bob",
...
describe('function findAuntsAndUncles', function() {
  it('Find aunts and uncles', function() {
    expect(findAuntsAndUncles(		{
    		"id": 313207561,
    		"firstName": "Mattias",
    		"lastName": "Madden",
    		"gender": "male",
...
describe('function findOldestChild', function() {
  it('Find oldest child out of the list given.', function() {
    expect(findOldestChild(data, [	{
    		"id": 272822514,
    		"firstName": "Billy",
    		"lastName": "Bob",
    		"gender": "male",
...
describe('function findChildren', function() {
  it('Find Michael Walkens children', function() {
    expect(findChildren([	{
    		...
    		"parents": [],
    		"currentSpouse": 260451248
    	}], data)).toEqual(["Jasmine Bob"]);
  });
});

describe('function findGrandParents', function() {
  it('Find grandParents', function() {
    expect(findGrandParents(	{
    		"id": 313998000,
    		"firstName": "Joey",
    		"lastName": "Madden",
    		"gender": "female",
...
describe('function findSiblings', function() {
  it('Find siblings', function() {
    expect(findSiblings({
  		"id": 313207561,
  		"firstName": "Mattias",
  		"lastName": "Madden",
  		...
  		"parents": [693243224, 888201200],
  		"currentSpouse": 313997561
  	}, data)).toEqual([ 'Regina Madden', 'Hana Madden', 'Eloise Madden', 'Regina Madden', 'Hana Madden', 'Eloise Madden' ] );
  });
});



describe('function findAllChildren', function() {
  it('Find result of all children', function() {
    expect(findAllChildren([	{
    		"id": 888201200,
    		"firstName": "Mader",
    		"lastName": "Madden",
    		"gender": "male",
